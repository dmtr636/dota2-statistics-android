...
import com.kodimstudio.dota2stats.databinding.FragmentMatchFarmBinding
import com.kodimstudio.dota2stats.adapters.MatchFarmListAdapter

class MatchFarmFragment : Fragment() {

    private lateinit var binding: FragmentMatchFarmBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentMatchFarmBinding.inflate(inflater, container, false)
        ...
        val radiantListAdapter = MatchFarmListAdapter(
            MatchDetailsActivity.radiantPlayersList,
            height.toInt(),
            requireContext()
        )
        val direListAdapter = MatchFarmListAdapter(
